...
class HelpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post helps_url, params: { help: { comments: @help.comments, country: @help.country, genre: @help.genre, task: @help.task, timeframe: @help.timeframe } }
    end
  ...
  test "should update help" do
    patch help_url(@help), params: { help: { comments: @help.comments, country: @help.country, genre: @help.genre, task: @help.task, timeframe: @help.timeframe } }
